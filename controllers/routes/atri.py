...
class Atri:
	def __init__(self, state: Any):
		...
		self.Navbar_section = state["Navbar_section"]
		self.mng_navbar = state["mng_navbar"]
		self.header = state["header"]
		self.mg_header = state["mg_header"]
		self.Hero_section = state["Hero_section"]
		self.mng_hero = state["mng_hero"]
		self.bottom_multiple_icon = state["bottom_multiple_icon"]
		self.Cover_section = state["Cover_section"]
		self.mng_cover = state["mng_cover"]
		self.content = state["content"]
		self.left_content_textbox = state["left_content_textbox"]
		self.mng_content_textbox = state["mng_content_textbox"]
		self.bold_content_textbox = state["bold_content_textbox"]
		self.mini_text = state["mini_text"]
		self.cover_links = state["cover_links"]
		self.content_button = state["content_button"]
		self.mng_cover_btn = state["mng_cover_btn"]
		self.right_content_img = state["right_content_img"]
		self.Album_section = state["Album_section"]
		self.mng_album = state["mng_album"]
		self.top_album = state["top_album"]
		self.mng_service = state["mng_service"]
		self.service_container = state["service_container"]
		self.bottom_album = state["bottom_album"]
		self.album1 = state["album1"]
		self.album_icon1 = state["album_icon1"]
		self.album1_mini_textbox = state["album1_mini_textbox"]
		self.album1_list = state["album1_list"]
		self.album1_orderlist2 = state["album1_orderlist2"]
		self.album1_orderlist_textbox2 = state["album1_orderlist_textbox2"]
		self.album1_orderlist1 = state["album1_orderlist1"]
		self.album1_orderlist_textbox_1 = state["album1_orderlist_textbox_1"]
		self.album1_orderlist3 = state["album1_orderlist3"]
		self.album1_orderlist_textbox3 = state["album1_orderlist_textbox3"]
		self.album2 = state["album2"]
		...
		self.Slider_section = state["Slider_section"]
		self.mng_slider = state["mng_slider"]
		self.top_slider = state["top_slider"]
		self.mng_top_slider = state["mng_top_slider"]
		self.left_project_txtbox = state["left_project_txtbox"]
		self.top_project_textbox = state["top_project_textbox"]
		self.bottom_bold_textbox = state["bottom_bold_textbox"]
		self.top_project_bold_txtbox1 = state["top_project_bold_txtbox1"]
		self.bottom_project_bold_txtbox2 = state["bottom_project_bold_txtbox2"]
		self.right_project_btn = state["right_project_btn"]
		self.mng_project_btn = state["mng_project_btn"]
		self.bottom_slider = state["bottom_slider"]
		...
		self.arrow_icon1 = state["arrow_icon1"]
		self.about = state["about"]
		self.services = state["services"]
		self.project = state["project"]
		self.blog = state["blog"]
		self.bookcall = state["bookcall"]
		self.top_trusted_by = state["top_trusted_by"]
		self.icon1 = state["icon1"]
		self.icon2 = state["icon2"]
		self.icon3 = state["icon3"]
		self.icon4 = state["icon4"]
		self.bold__text1 = state["bold__text1"]
		self.bold_text2 = state["bold_text2"]
		self.TextBox24 = state["TextBox24"]
		self.cover_download_link = state["cover_download_link"]
		self.arrow_icon2 = state["arrow_icon2"]
		self.back_btn = state["back_btn"]
		self.cover_button = state["cover_button"]
		self.cover_img = state["cover_img"]
		self.bottom_bold_service_textbox = state["bottom_bold_service_textbox"]
		self.top_service_textbox = state["top_service_textbox"]
		self.album1_bold_txt = state["album1_bold_txt"]
		self.Image14 = state["Image14"]
		self.album1_mini_txt = state["album1_mini_txt"]
		self.album1_circle2 = state["album1_circle2"]
		self.album1_orderlist_text = state["album1_orderlist_text"]
		self.album1_circle1 = state["album1_circle1"]
		self.TextBox30 = state["TextBox30"]
		self.album1_circle3 = state["album1_circle3"]
		self.album1_orderlist_text3 = state["album1_orderlist_text3"]
		...
		self.project_txt = state["project_txt"]
		self.project_bold_text1 = state["project_bold_text1"]
		self.project_bold_text2 = state["project_bold_text2"]
		self.project_button = state["project_button"]
		self.project_back_btn = state["project_back_btn"]
	...
	@property
	def Navbar_section(self):
		self._getter_access_tracker["Navbar_section"] = {}
		return self._Navbar_section
	@Navbar_section.setter
	def Navbar_section(self, new_state):
		self._setter_access_tracker["Navbar_section"] = {}
		global default_state
		self._Navbar_section = Flex(new_state, default_state["Navbar_section"])

	@property
	def mng_navbar(self):
		self._getter_access_tracker["mng_navbar"] = {}
		return self._mng_navbar
	@mng_navbar.setter
	def mng_navbar(self, new_state):
		self._setter_access_tracker["mng_navbar"] = {}
		global default_state
		self._mng_navbar = Flex(new_state, default_state["mng_navbar"])
	...
	@property
	def mg_header(self):
		self._getter_access_tracker["mg_header"] = {}
		return self._mg_header
	@mg_header.setter
	def mg_header(self, new_state):
		self._setter_access_tracker["mg_header"] = {}
		global default_state
		self._mg_header = Flex(new_state, default_state["mg_header"])
	...
	def Hero_section(self, new_state):
		...
		global default_state
		self._Hero_section = Flex(new_state, default_state["Hero_section"])

	@property
	def mng_hero(self):
		self._getter_access_tracker["mng_hero"] = {}
		return self._mng_hero
	@mng_hero.setter
	def mng_hero(self, new_state):
		self._setter_access_tracker["mng_hero"] = {}
		global default_state
		self._mng_hero = Flex(new_state, default_state["mng_hero"])

	@property
	def bottom_multiple_icon(self):
		self._getter_access_tracker["bottom_multiple_icon"] = {}
		return self._bottom_multiple_icon
	@bottom_multiple_icon.setter
	def bottom_multiple_icon(self, new_state):
		self._setter_access_tracker["bottom_multiple_icon"] = {}
		global default_state
		self._bottom_multiple_icon = Flex(new_state, default_state["bottom_multiple_icon"])

	@property
	def Cover_section(self):
		self._getter_access_tracker["Cover_section"] = {}
		return self._Cover_section
	@Cover_section.setter
	def Cover_section(self, new_state):
		self._setter_access_tracker["Cover_section"] = {}
		global default_state
		self._Cover_section = Flex(new_state, default_state["Cover_section"])

	@property
	def mng_cover(self):
		self._getter_access_tracker["mng_cover"] = {}
		return self._mng_cover
	@mng_cover.setter
	def mng_cover(self, new_state):
		self._setter_access_tracker["mng_cover"] = {}
		global default_state
		self._mng_cover = Flex(new_state, default_state["mng_cover"])
	...
	@property
	def left_content_textbox(self):
		self._getter_access_tracker["left_content_textbox"] = {}
		return self._left_content_textbox
	@left_content_textbox.setter
	def left_content_textbox(self, new_state):
		self._setter_access_tracker["left_content_textbox"] = {}
		global default_state
		self._left_content_textbox = Flex(new_state, default_state["left_content_textbox"])

	@property
	def mng_content_textbox(self):
		self._getter_access_tracker["mng_content_textbox"] = {}
		return self._mng_content_textbox
	@mng_content_textbox.setter
	def mng_content_textbox(self, new_state):
		self._setter_access_tracker["mng_content_textbox"] = {}
		global default_state
		self._mng_content_textbox = Flex(new_state, default_state["mng_content_textbox"])

	@property
	def bold_content_textbox(self):
		self._getter_access_tracker["bold_content_textbox"] = {}
		return self._bold_content_textbox
	@bold_content_textbox.setter
	def bold_content_textbox(self, new_state):
		self._setter_access_tracker["bold_content_textbox"] = {}
		global default_state
		self._bold_content_textbox = Flex(new_state, default_state["bold_content_textbox"])

	@property
	def mini_text(self):
		self._getter_access_tracker["mini_text"] = {}
		return self._mini_text
	@mini_text.setter
	def mini_text(self, new_state):
		self._setter_access_tracker["mini_text"] = {}
		global default_state
		self._mini_text = Div(new_state, default_state["mini_text"])

	@property
	def cover_links(self):
		self._getter_access_tracker["cover_links"] = {}
		return self._cover_links
	@cover_links.setter
	def cover_links(self, new_state):
		self._setter_access_tracker["cover_links"] = {}
		global default_state
		self._cover_links = Div(new_state, default_state["cover_links"])

	@property
	def content_button(self):
		self._getter_access_tracker["content_button"] = {}
		return self._content_button
	@content_button.setter
	def content_button(self, new_state):
		self._setter_access_tracker["content_button"] = {}
		global default_state
		self._content_button = Flex(new_state, default_state["content_button"])

	@property
	def mng_cover_btn(self):
		self._getter_access_tracker["mng_cover_btn"] = {}
		return self._mng_cover_btn
	@mng_cover_btn.setter
	def mng_cover_btn(self, new_state):
		self._setter_access_tracker["mng_cover_btn"] = {}
		global default_state
		self._mng_cover_btn = Flex(new_state, default_state["mng_cover_btn"])

	@property
	def right_content_img(self):
		self._getter_access_tracker["right_content_img"] = {}
		return self._right_content_img
	@right_content_img.setter
	def right_content_img(self, new_state):
		self._setter_access_tracker["right_content_img"] = {}
		global default_state
		self._right_content_img = Flex(new_state, default_state["right_content_img"])

	@property
	def Album_section(self):
		self._getter_access_tracker["Album_section"] = {}
		return self._Album_section
	@Album_section.setter
	def Album_section(self, new_state):
		self._setter_access_tracker["Album_section"] = {}
		global default_state
		self._Album_section = Flex(new_state, default_state["Album_section"])

	@property
	def mng_album(self):
		self._getter_access_tracker["mng_album"] = {}
		return self._mng_album
	@mng_album.setter
	def mng_album(self, new_state):
		self._setter_access_tracker["mng_album"] = {}
		global default_state
		self._mng_album = Flex(new_state, default_state["mng_album"])

	@property
	def top_album(self):
		self._getter_access_tracker["top_album"] = {}
		return self._top_album
	@top_album.setter
	def top_album(self, new_state):
		self._setter_access_tracker["top_album"] = {}
		global default_state
		self._top_album = Flex(new_state, default_state["top_album"])

	@property
	def mng_service(self):
		self._getter_access_tracker["mng_service"] = {}
		return self._mng_service
	@mng_service.setter
	def mng_service(self, new_state):
		self._setter_access_tracker["mng_service"] = {}
		global default_state
		self._mng_service = Flex(new_state, default_state["mng_service"])

	@property
	def service_container(self):
		self._getter_access_tracker["service_container"] = {}
		return self._service_container
	@service_container.setter
	def service_container(self, new_state):
		self._setter_access_tracker["service_container"] = {}
		global default_state
		self._service_container = Div(new_state, default_state["service_container"])

	@property
	def bottom_album(self):
		self._getter_access_tracker["bottom_album"] = {}
		return self._bottom_album
	@bottom_album.setter
	def bottom_album(self, new_state):
		self._setter_access_tracker["bottom_album"] = {}
		global default_state
		self._bottom_album = Flex(new_state, default_state["bottom_album"])

	@property
	def album1(self):
		self._getter_access_tracker["album1"] = {}
		return self._album1
	@album1.setter
	def album1(self, new_state):
		self._setter_access_tracker["album1"] = {}
		global default_state
		self._album1 = Flex(new_state, default_state["album1"])

	@property
	def album_icon1(self):
		self._getter_access_tracker["album_icon1"] = {}
		return self._album_icon1
	@album_icon1.setter
	def album_icon1(self, new_state):
		self._setter_access_tracker["album_icon1"] = {}
		global default_state
		self._album_icon1 = Flex(new_state, default_state["album_icon1"])

	@property
	def album1_mini_textbox(self):
		self._getter_access_tracker["album1_mini_textbox"] = {}
		return self._album1_mini_textbox
	@album1_mini_textbox.setter
	def album1_mini_textbox(self, new_state):
		self._setter_access_tracker["album1_mini_textbox"] = {}
		global default_state
		self._album1_mini_textbox = Flex(new_state, default_state["album1_mini_textbox"])

	@property
	def album1_list(self):
		self._getter_access_tracker["album1_list"] = {}
		return self._album1_list
	@album1_list.setter
	def album1_list(self, new_state):
		self._setter_access_tracker["album1_list"] = {}
		global default_state
		self._album1_list = Flex(new_state, default_state["album1_list"])

	@property
	def album1_orderlist2(self):
		self._getter_access_tracker["album1_orderlist2"] = {}
		return self._album1_orderlist2
	@album1_orderlist2.setter
	def album1_orderlist2(self, new_state):
		self._setter_access_tracker["album1_orderlist2"] = {}
		global default_state
		self._album1_orderlist2 = Flex(new_state, default_state["album1_orderlist2"])

	@property
	def album1_orderlist_textbox2(self):
		self._getter_access_tracker["album1_orderlist_textbox2"] = {}
		return self._album1_orderlist_textbox2
	@album1_orderlist_textbox2.setter
	def album1_orderlist_textbox2(self, new_state):
		self._setter_access_tracker["album1_orderlist_textbox2"] = {}
		global default_state
		self._album1_orderlist_textbox2 = Div(new_state, default_state["album1_orderlist_textbox2"])

	@property
	def album1_orderlist1(self):
		self._getter_access_tracker["album1_orderlist1"] = {}
		return self._album1_orderlist1
	@album1_orderlist1.setter
	def album1_orderlist1(self, new_state):
		self._setter_access_tracker["album1_orderlist1"] = {}
		global default_state
		self._album1_orderlist1 = Flex(new_state, default_state["album1_orderlist1"])

	@property
	def album1_orderlist_textbox_1(self):
		self._getter_access_tracker["album1_orderlist_textbox_1"] = {}
		return self._album1_orderlist_textbox_1
	@album1_orderlist_textbox_1.setter
	def album1_orderlist_textbox_1(self, new_state):
		self._setter_access_tracker["album1_orderlist_textbox_1"] = {}
		global default_state
		self._album1_orderlist_textbox_1 = Div(new_state, default_state["album1_orderlist_textbox_1"])

	@property
	def album1_orderlist3(self):
		self._getter_access_tracker["album1_orderlist3"] = {}
		return self._album1_orderlist3
	@album1_orderlist3.setter
	def album1_orderlist3(self, new_state):
		self._setter_access_tracker["album1_orderlist3"] = {}
		global default_state
		self._album1_orderlist3 = Flex(new_state, default_state["album1_orderlist3"])

	@property
	def album1_orderlist_textbox3(self):
		self._getter_access_tracker["album1_orderlist_textbox3"] = {}
		return self._album1_orderlist_textbox3
	@album1_orderlist_textbox3.setter
	def album1_orderlist_textbox3(self, new_state):
		self._setter_access_tracker["album1_orderlist_textbox3"] = {}
		global default_state
		self._album1_orderlist_textbox3 = Div(new_state, default_state["album1_orderlist_textbox3"])

	@property
	def album2(self):
		self._getter_access_tracker["album2"] = {}
		return self._album2
	@album2.setter
	def album2(self, new_state):
		self._setter_access_tracker["album2"] = {}
		global default_state
		self._album2 = Flex(new_state, default_state["album2"])
	...
	@property
	def album3(self):
		self._getter_access_tracker["album3"] = {}
		return self._album3
	@album3.setter
	def album3(self, new_state):
		self._setter_access_tracker["album3"] = {}
		global default_state
		self._album3 = Flex(new_state, default_state["album3"])
	...
	@property
	def Slider_section(self):
		self._getter_access_tracker["Slider_section"] = {}
		return self._Slider_section
	@Slider_section.setter
	def Slider_section(self, new_state):
		self._setter_access_tracker["Slider_section"] = {}
		global default_state
		self._Slider_section = Flex(new_state, default_state["Slider_section"])

	@property
	def mng_slider(self):
		self._getter_access_tracker["mng_slider"] = {}
		return self._mng_slider
	@mng_slider.setter
	def mng_slider(self, new_state):
		self._setter_access_tracker["mng_slider"] = {}
		global default_state
		self._mng_slider = Flex(new_state, default_state["mng_slider"])

	@property
	def top_slider(self):
		self._getter_access_tracker["top_slider"] = {}
		return self._top_slider
	@top_slider.setter
	def top_slider(self, new_state):
		self._setter_access_tracker["top_slider"] = {}
		global default_state
		self._top_slider = Flex(new_state, default_state["top_slider"])

	@property
	def mng_top_slider(self):
		self._getter_access_tracker["mng_top_slider"] = {}
		return self._mng_top_slider
	@mng_top_slider.setter
	def mng_top_slider(self, new_state):
		self._setter_access_tracker["mng_top_slider"] = {}
		global default_state
		self._mng_top_slider = Flex(new_state, default_state["mng_top_slider"])

	@property
	def left_project_txtbox(self):
		self._getter_access_tracker["left_project_txtbox"] = {}
		return self._left_project_txtbox
	@left_project_txtbox.setter
	def left_project_txtbox(self, new_state):
		self._setter_access_tracker["left_project_txtbox"] = {}
		global default_state
		self._left_project_txtbox = Flex(new_state, default_state["left_project_txtbox"])

	@property
	def top_project_textbox(self):
		self._getter_access_tracker["top_project_textbox"] = {}
		return self._top_project_textbox
	@top_project_textbox.setter
	def top_project_textbox(self, new_state):
		self._setter_access_tracker["top_project_textbox"] = {}
		global default_state
		self._top_project_textbox = Div(new_state, default_state["top_project_textbox"])

	@property
	def bottom_bold_textbox(self):
		self._getter_access_tracker["bottom_bold_textbox"] = {}
		return self._bottom_bold_textbox
	@bottom_bold_textbox.setter
	def bottom_bold_textbox(self, new_state):
		self._setter_access_tracker["bottom_bold_textbox"] = {}
		global default_state
		self._bottom_bold_textbox = Flex(new_state, default_state["bottom_bold_textbox"])

	@property
	def top_project_bold_txtbox1(self):
		self._getter_access_tracker["top_project_bold_txtbox1"] = {}
		return self._top_project_bold_txtbox1
	@top_project_bold_txtbox1.setter
	def top_project_bold_txtbox1(self, new_state):
		self._setter_access_tracker["top_project_bold_txtbox1"] = {}
		global default_state
		self._top_project_bold_txtbox1 = Div(new_state, default_state["top_project_bold_txtbox1"])

	@property
	def bottom_project_bold_txtbox2(self):
		self._getter_access_tracker["bottom_project_bold_txtbox2"] = {}
		return self._bottom_project_bold_txtbox2
	@bottom_project_bold_txtbox2.setter
	def bottom_project_bold_txtbox2(self, new_state):
		self._setter_access_tracker["bottom_project_bold_txtbox2"] = {}
		global default_state
		self._bottom_project_bold_txtbox2 = Div(new_state, default_state["bottom_project_bold_txtbox2"])

	@property
	def right_project_btn(self):
		self._getter_access_tracker["right_project_btn"] = {}
		return self._right_project_btn
	@right_project_btn.setter
	def right_project_btn(self, new_state):
		self._setter_access_tracker["right_project_btn"] = {}
		global default_state
		self._right_project_btn = Flex(new_state, default_state["right_project_btn"])

	@property
	def mng_project_btn(self):
		self._getter_access_tracker["mng_project_btn"] = {}
		return self._mng_project_btn
	@mng_project_btn.setter
	def mng_project_btn(self, new_state):
		self._setter_access_tracker["mng_project_btn"] = {}
		global default_state
		self._mng_project_btn = Flex(new_state, default_state["mng_project_btn"])

	@property
	def bottom_slider(self):
		self._getter_access_tracker["bottom_slider"] = {}
		return self._bottom_slider
	@bottom_slider.setter
	def bottom_slider(self, new_state):
		self._setter_access_tracker["bottom_slider"] = {}
		global default_state
		self._bottom_slider = Flex(new_state, default_state["bottom_slider"])
	...
	@property
	def arrow_icon1(self):
		self._getter_access_tracker["arrow_icon1"] = {}
		return self._arrow_icon1
	@arrow_icon1.setter
	def arrow_icon1(self, new_state):
		self._setter_access_tracker["arrow_icon1"] = {}
		global default_state
		self._arrow_icon1 = Image(new_state, default_state["arrow_icon1"])
	...
	def bookcall(self, new_state):
		...
		global default_state
		self._bookcall = Link(new_state, default_state["bookcall"])

	@property
	def top_trusted_by(self):
		self._getter_access_tracker["top_trusted_by"] = {}
		return self._top_trusted_by
	@top_trusted_by.setter
	def top_trusted_by(self, new_state):
		self._setter_access_tracker["top_trusted_by"] = {}
		global default_state
		self._top_trusted_by = TextBox(new_state, default_state["top_trusted_by"])
	...
	def icon4(self, new_state):
		...
		global default_state
		self._icon4 = Image(new_state, default_state["icon4"])

	@property
	def bold__text1(self):
		self._getter_access_tracker["bold__text1"] = {}
		return self._bold__text1
	@bold__text1.setter
	def bold__text1(self, new_state):
		self._setter_access_tracker["bold__text1"] = {}
		global default_state
		self._bold__text1 = TextBox(new_state, default_state["bold__text1"])

	@property
	def bold_text2(self):
		self._getter_access_tracker["bold_text2"] = {}
		return self._bold_text2
	@bold_text2.setter
	def bold_text2(self, new_state):
		self._setter_access_tracker["bold_text2"] = {}
		global default_state
		self._bold_text2 = TextBox(new_state, default_state["bold_text2"])
	...
	@property
	def cover_download_link(self):
		self._getter_access_tracker["cover_download_link"] = {}
		return self._cover_download_link
	@cover_download_link.setter
	def cover_download_link(self, new_state):
		self._setter_access_tracker["cover_download_link"] = {}
		global default_state
		self._cover_download_link = Link(new_state, default_state["cover_download_link"])

	@property
	def arrow_icon2(self):
		self._getter_access_tracker["arrow_icon2"] = {}
		return self._arrow_icon2
	@arrow_icon2.setter
	def arrow_icon2(self, new_state):
		self._setter_access_tracker["arrow_icon2"] = {}
		global default_state
		self._arrow_icon2 = Image(new_state, default_state["arrow_icon2"])

	@property
	def back_btn(self):
		self._getter_access_tracker["back_btn"] = {}
		return self._back_btn
	@back_btn.setter
	def back_btn(self, new_state):
		self._setter_access_tracker["back_btn"] = {}
		global default_state
		self._back_btn = Flex(new_state, default_state["back_btn"])

	@property
	def cover_button(self):
		self._getter_access_tracker["cover_button"] = {}
		return self._cover_button
	@cover_button.setter
	def cover_button(self, new_state):
		self._setter_access_tracker["cover_button"] = {}
		global default_state
		self._cover_button = Button(new_state, default_state["cover_button"])

	@property
	def cover_img(self):
		self._getter_access_tracker["cover_img"] = {}
		return self._cover_img
	@cover_img.setter
	def cover_img(self, new_state):
		self._setter_access_tracker["cover_img"] = {}
		global default_state
		self._cover_img = Image(new_state, default_state["cover_img"])

	@property
	def bottom_bold_service_textbox(self):
		self._getter_access_tracker["bottom_bold_service_textbox"] = {}
		return self._bottom_bold_service_textbox
	@bottom_bold_service_textbox.setter
	def bottom_bold_service_textbox(self, new_state):
		self._setter_access_tracker["bottom_bold_service_textbox"] = {}
		global default_state
		self._bottom_bold_service_textbox = TextBox(new_state, default_state["bottom_bold_service_textbox"])

	@property
	def top_service_textbox(self):
		self._getter_access_tracker["top_service_textbox"] = {}
		return self._top_service_textbox
	@top_service_textbox.setter
	def top_service_textbox(self, new_state):
		self._setter_access_tracker["top_service_textbox"] = {}
		global default_state
		self._top_service_textbox = TextBox(new_state, default_state["top_service_textbox"])

	@property
	def album1_bold_txt(self):
		self._getter_access_tracker["album1_bold_txt"] = {}
		return self._album1_bold_txt
	@album1_bold_txt.setter
	def album1_bold_txt(self, new_state):
		self._setter_access_tracker["album1_bold_txt"] = {}
		global default_state
		self._album1_bold_txt = TextBox(new_state, default_state["album1_bold_txt"])
	...
	@property
	def album1_mini_txt(self):
		self._getter_access_tracker["album1_mini_txt"] = {}
		return self._album1_mini_txt
	@album1_mini_txt.setter
	def album1_mini_txt(self, new_state):
		self._setter_access_tracker["album1_mini_txt"] = {}
		global default_state
		self._album1_mini_txt = TextBox(new_state, default_state["album1_mini_txt"])

	@property
	def album1_circle2(self):
		self._getter_access_tracker["album1_circle2"] = {}
		return self._album1_circle2
	@album1_circle2.setter
	def album1_circle2(self, new_state):
		self._setter_access_tracker["album1_circle2"] = {}
		global default_state
		self._album1_circle2 = Div(new_state, default_state["album1_circle2"])

	@property
	def album1_orderlist_text(self):
		self._getter_access_tracker["album1_orderlist_text"] = {}
		return self._album1_orderlist_text
	@album1_orderlist_text.setter
	def album1_orderlist_text(self, new_state):
		self._setter_access_tracker["album1_orderlist_text"] = {}
		global default_state
		self._album1_orderlist_text = TextBox(new_state, default_state["album1_orderlist_text"])

	@property
	def album1_circle1(self):
		self._getter_access_tracker["album1_circle1"] = {}
		return self._album1_circle1
	@album1_circle1.setter
	def album1_circle1(self, new_state):
		self._setter_access_tracker["album1_circle1"] = {}
		global default_state
		self._album1_circle1 = Div(new_state, default_state["album1_circle1"])
	...
	@property
	def album1_circle3(self):
		self._getter_access_tracker["album1_circle3"] = {}
		return self._album1_circle3
	@album1_circle3.setter
	def album1_circle3(self, new_state):
		self._setter_access_tracker["album1_circle3"] = {}
		global default_state
		self._album1_circle3 = Div(new_state, default_state["album1_circle3"])

	@property
	def album1_orderlist_text3(self):
		self._getter_access_tracker["album1_orderlist_text3"] = {}
		return self._album1_orderlist_text3
	@album1_orderlist_text3.setter
	def album1_orderlist_text3(self, new_state):
		self._setter_access_tracker["album1_orderlist_text3"] = {}
		global default_state
		self._album1_orderlist_text3 = TextBox(new_state, default_state["album1_orderlist_text3"])
	...
	@property
	def project_txt(self):
		self._getter_access_tracker["project_txt"] = {}
		return self._project_txt
	@project_txt.setter
	def project_txt(self, new_state):
		self._setter_access_tracker["project_txt"] = {}
		global default_state
		self._project_txt = TextBox(new_state, default_state["project_txt"])

	@property
	def project_bold_text1(self):
		self._getter_access_tracker["project_bold_text1"] = {}
		return self._project_bold_text1
	@project_bold_text1.setter
	def project_bold_text1(self, new_state):
		self._setter_access_tracker["project_bold_text1"] = {}
		global default_state
		self._project_bold_text1 = TextBox(new_state, default_state["project_bold_text1"])

	@property
	def project_bold_text2(self):
		self._getter_access_tracker["project_bold_text2"] = {}
		return self._project_bold_text2
	@project_bold_text2.setter
	def project_bold_text2(self, new_state):
		self._setter_access_tracker["project_bold_text2"] = {}
		global default_state
		self._project_bold_text2 = TextBox(new_state, default_state["project_bold_text2"])

	@property
	def project_button(self):
		self._getter_access_tracker["project_button"] = {}
		return self._project_button
	@project_button.setter
	def project_button(self, new_state):
		self._setter_access_tracker["project_button"] = {}
		global default_state
		self._project_button = Button(new_state, default_state["project_button"])

	@property
	def project_back_btn(self):
		self._getter_access_tracker["project_back_btn"] = {}
		return self._project_back_btn
	@project_back_btn.setter
	def project_back_btn(self, new_state):
		self._setter_access_tracker["project_back_btn"] = {}
		global default_state
		self._project_back_btn = Flex(new_state, default_state["project_back_btn"])
	...
	def _to_json_fields(self):
		return {
			"Navbar_section": self._Navbar_section,
			"mng_navbar": self._mng_navbar,
			"header": self._header,
			"mg_header": self._mg_header,
			"Hero_section": self._Hero_section,
			"mng_hero": self._mng_hero,
			"bottom_multiple_icon": self._bottom_multiple_icon,
			"Cover_section": self._Cover_section,
			"mng_cover": self._mng_cover,
			"content": self._content,
			"left_content_textbox": self._left_content_textbox,
			"mng_content_textbox": self._mng_content_textbox,
			"bold_content_textbox": self._bold_content_textbox,
			"mini_text": self._mini_text,
			"cover_links": self._cover_links,
			"content_button": self._content_button,
			"mng_cover_btn": self._mng_cover_btn,
			"right_content_img": self._right_content_img,
			"Album_section": self._Album_section,
			"mng_album": self._mng_album,
			"top_album": self._top_album,
			"mng_service": self._mng_service,
			"service_container": self._service_container,
			"bottom_album": self._bottom_album,
			"album1": self._album1,
			"album_icon1": self._album_icon1,
			"album1_mini_textbox": self._album1_mini_textbox,
			"album1_list": self._album1_list,
			"album1_orderlist2": self._album1_orderlist2,
			"album1_orderlist_textbox2": self._album1_orderlist_textbox2,
			"album1_orderlist1": self._album1_orderlist1,
			"album1_orderlist_textbox_1": self._album1_orderlist_textbox_1,
			"album1_orderlist3": self._album1_orderlist3,
			"album1_orderlist_textbox3": self._album1_orderlist_textbox3,
			"album2": self._album2,
			"Flex54": self._Flex54,
			"Flex51": self._Flex51,
			"Div24": self._Div24,
			...
			"Flex62": self._Flex62,
			"Flex63": self._Flex63,
			"Slider_section": self._Slider_section,
			"mng_slider": self._mng_slider,
			"top_slider": self._top_slider,
			"mng_top_slider": self._mng_top_slider,
			"left_project_txtbox": self._left_project_txtbox,
			"top_project_textbox": self._top_project_textbox,
			"bottom_bold_textbox": self._bottom_bold_textbox,
			"top_project_bold_txtbox1": self._top_project_bold_txtbox1,
			"bottom_project_bold_txtbox2": self._bottom_project_bold_txtbox2,
			"right_project_btn": self._right_project_btn,
			"mng_project_btn": self._mng_project_btn,
			"bottom_slider": self._bottom_slider,
			...
			"logo": self._logo,
			"arrow_icon1": self._arrow_icon1,
			"about": self._about,
			"services": self._services,
			"project": self._project,
			"blog": self._blog,
			"bookcall": self._bookcall,
			"top_trusted_by": self._top_trusted_by,
			"icon1": self._icon1,
			"icon2": self._icon2,
			"icon3": self._icon3,
			"icon4": self._icon4,
			"bold__text1": self._bold__text1,
			"bold_text2": self._bold_text2,
			"TextBox24": self._TextBox24,
			"cover_download_link": self._cover_download_link,
			"arrow_icon2": self._arrow_icon2,
			"back_btn": self._back_btn,
			"cover_button": self._cover_button,
			"cover_img": self._cover_img,
			"bottom_bold_service_textbox": self._bottom_bold_service_textbox,
			"top_service_textbox": self._top_service_textbox,
			"album1_bold_txt": self._album1_bold_txt,
			"Image14": self._Image14,
			"album1_mini_txt": self._album1_mini_txt,
			"album1_circle2": self._album1_circle2,
			"album1_orderlist_text": self._album1_orderlist_text,
			"album1_circle1": self._album1_circle1,
			"TextBox30": self._TextBox30,
			"album1_circle3": self._album1_circle3,
			"album1_orderlist_text3": self._album1_orderlist_text3,
			...
			"project_txt": self._project_txt,
			"project_bold_text1": self._project_bold_text1,
			"project_bold_text2": self._project_bold_text2,
			"project_button": self._project_button,
			"project_back_btn": self._project_back_btn,
